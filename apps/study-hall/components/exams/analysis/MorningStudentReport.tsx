...
import type { ReportSection } from "./RegularStudentReport";
...
export function MorningStudentReport({ report, mode, section }: { report: Report; mode: "admin" | "student"; section?: ReportSection }) {
  ...
  return <div className="admin-flat-page">
    ...
    {show("trend") && <section id="personal-trend" className="admin-section"><h2 className="admin-section-title">과목별 추세</h2>
    ...
    {show("subjects") && <section className="admin-section"><h2 id="personal-subjects" className="admin-section-title">단원별 취약</h2><p className="admin-help">반 평균보다 낮은 단원부터 확인합니다. 격차는 내 평균 − 반 평균입니다.</p>
    ...
    {show("subjects") && <section className="admin-section"><h2 id="personal-items" className="admin-section-title">날짜별 문항 분석</h2>
      <p className="admin-help">시험일이 쌓이면 목록이 길어지므로 접어 둡니다.</p>
