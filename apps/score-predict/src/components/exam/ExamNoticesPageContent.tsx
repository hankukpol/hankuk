      ...
      <section className="overflow-hidden rounded-xl border border-slate-200 bg-white">
        ...
        <footer className="flex items-center justify-between gap-3 border-t border-slate-200 bg-slate-50 px-5 py-4 sm:px-6">
          ...
          <button
            ...
            className="rounded-md border border-slate-300 bg-white px-4 py-2 text-sm font-semibold text-slate-700 transition-colors hover:bg-slate-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-service-600 focus-visible:ring-offset-2"
          >
            목록
          </button>
        </footer>
    ...
    <section className="space-y-4">
      <header className="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
        ...
        <form onSubmit={handleSearch} className="flex w-full sm:max-w-sm" role="search">
          ...
          <button
            type="submit"
            className="inline-flex items-center justify-center gap-2 rounded-r-md bg-service-700 px-4 py-2 text-sm font-semibold text-white transition-colors hover:bg-service-600 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-service-600 focus-visible:ring-offset-2"
          >
