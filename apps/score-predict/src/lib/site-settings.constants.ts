...
export const SITE_SETTING_TYPES: Record<SiteSettingKey, SiteSettingValueType> = {
  ...
  "site.adminPreRegistrationsEnabled": "boolean",
  "site.adminSubmissionsEnabled": "boolean",
  "site.adminStatsEnabled": "boolean",
  "site.adminVisitorsEnabled": "boolean",
  "site.adminUsersEnabled": "boolean",
  "site.adminCommentsEnabled": "boolean",
  "site.adminExamsEnabled": "boolean",
  "site.adminAnswersEnabled": "boolean",
  "site.adminRegionsEnabled": "boolean",
  "site.adminPassCutEnabled": "boolean",
  "site.adminMockDataEnabled": "boolean",
  "site.adminOpenResetEnabled": "boolean",
  "site.adminSiteHubEnabled": "boolean",
  "site.adminSiteBasicEnabled": "boolean",
  "site.adminSitePoliciesEnabled": "boolean",
  "site.adminSiteVisibilityEnabled": "boolean",
  "site.adminSiteOperationsEnabled": "boolean",
  "site.adminSiteAutoPassCutEnabled": "boolean",
...
export const SITE_SETTING_DEFAULTS: SiteSettingsMap = {
  "site.title": "한국소방 합격예측",
  "site.heroBadge": "2026년 한국소방 공채 필기시험 합격예측",
  "site.heroTitle": "OMR 답안 입력부터\n합격예측 확인까지 한 번에 진행하세요.",
  "site.heroSubtitle":
    "응시정보와 OMR 답안을 입력하면 과목별 분석, 예상 점수, 배수권 위치, 합격 가능성 정보를 실시간으로 확인할 수 있습니다.",
  "site.footerDisclaimer":
    "본 서비스는 수험생의 합격 예측을 위한 참고용 분석 도구이며, 실제 합격 여부를 보장하지 않습니다. 최종 결과는 소방청 및 시도소방본부의 공식 공고를 반드시 확인해 주세요.",
  ...
  "site.adminPreRegistrationsEnabled": true,
  "site.adminSubmissionsEnabled": true,
  "site.adminStatsEnabled": true,
  "site.adminVisitorsEnabled": true,
  "site.adminUsersEnabled": true,
  "site.adminCommentsEnabled": true,
  "site.adminExamsEnabled": true,
  "site.adminAnswersEnabled": true,
  "site.adminRegionsEnabled": true,
  "site.adminPassCutEnabled": true,
  "site.adminMockDataEnabled": true,
  "site.adminOpenResetEnabled": true,
  "site.adminSiteHubEnabled": true,
  "site.adminSiteBasicEnabled": true,
  "site.adminSitePoliciesEnabled": true,
  "site.adminSiteVisibilityEnabled": true,
  "site.adminSiteOperationsEnabled": true,
  "site.adminSiteAutoPassCutEnabled": true,
...
이 약관은 한국소방 합격예측 서비스(이하 "서비스")의 이용 조건과 운영 기준을 정합니다.

제2조 (서비스 이용)
서비스는 응시정보와 OMR 답안을 바탕으로 참고용 분석 결과를 제공합니다.
분석 결과는 실제 시험 결과와 차이가 있을 수 있으며, 최종 합격 여부는 소방청 및 시도소방본부의 공식 발표를 기준으로 합니다.
...
서비스는 참고용 분석 도구이며, 분석 결과를 기반으로 한 판단과 책임은 이용자에게 있습니다.`,
  "site.privacyPolicy": `한국소방 합격예측 서비스는 관련 법령에 따라 이용자의 개인정보를 아래와 같이 처리합니다.

1. 수집 항목
- 필수: 이름, 휴대전화번호, 복구 이메일, 비밀번호, 응시정보, OMR 답안
