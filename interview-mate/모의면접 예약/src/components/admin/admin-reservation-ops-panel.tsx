...
export function AdminReservationOpsPanel({
  ...
  return (
    <>
      ...
      {false && cancelTarget ? (
        <div className="fixed inset-0 z-[95] flex items-center justify-center bg-black/50 px-4 backdrop-blur-sm">
          <div className="w-full max-w-[420px] rounded-[16px] border border-black/5 bg-white p-5 shadow-header">
