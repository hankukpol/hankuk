  ...
  theme: {
    extend: {
      ...
      colors: {
        ...
        warn: {
          1: { DEFAULT: token("warn-1"), soft: token("warn-1-soft"), line: token("warn-1-line") },
          2: { DEFAULT: token("warn-2"), soft: token("warn-2-soft"), line: token("warn-2-line") },
          interview: { DEFAULT: token("warn-interview"), soft: token("warn-interview-soft"), line: token("warn-interview-line") },
          withdraw: { DEFAULT: token("warn-withdraw"), soft: token("warn-withdraw-soft"), line: token("warn-withdraw-line") },
        },
      },
    },
  },
