...
export function downloadPaymentImportTemplate() {
  ...
  const sheet = XLSX.utils.aoa_to_sheet([
    ['이름', '연락처', '응시번호', '생년월일', '수강료', '결제일', '결제방법', '카드사', '계좌 마지막 4자리', '분류', '비고'],
    ['홍길동', '01012345678', '12345', '900515', 60000, '2026-05-07', '카드', '신한', '', '수강료', ''],
    ['김철수', '01098765432', '', '19950322', 2900000, '2026-05-04', '카드', 'KB국민', '', '수강료', '장기분납'],
    ['이영희', '01055556666', '67890', '', 60000, '2026-05-07', '현금', '', '', '수강료', ''],
    ['박계좌', '01044443333', '', '', 60000, '2026-05-07', '계좌', '', '1234', '수강료', ''],
  ])
  sheet['!cols'] = [
