      ...
      >
        {reservation ? (
          <div className="space-y-4 rounded-[10px] border border-slate-200 bg-white p-4">
            ...
            <div className="grid gap-2 md:grid-cols-2">
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-[10px] border border-[var(--division-color)] bg-white px-5 py-2.5 text-sm font-semibold text-[var(--division-color)] disabled:cursor-not-allowed disabled:border-slate-200 disabled:text-slate-400"
              >
              ...
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-[10px] bg-rose-600 px-5 py-2.5 text-sm font-semibold text-white"
              >
          ...
          <div className="flex flex-col items-center justify-center gap-3 rounded-[10px] border border-dashed border-slate-300 bg-slate-50 px-4 py-10 text-center">
            <span className="flex h-12 w-12 items-center justify-center bg-white text-slate-400">
