...
import { PointPolicyManager } from "./point-policy-manager";
...
export default async function PointPoliciesPage() {
  ...
  return (
    <div className="p-8 sm:p-10">
      ...
      <p className="mt-4 max-w-3xl text-sm leading-8 text-slate sm:text-base">
        포인트 지급 시 빠르게 선택할 수 있는 제도 템플릿을 등록하고 관리합니다.
        지급 화면에서 제도를 선택하면 사유와 기본 금액이 자동으로 입력됩니다.
      </p>
      <div className="mt-8">
        <PointPolicyManager initialPolicies={rows} />
      </div>
    </div>
  );
}
