...
export function GradeReportPrintButton() {
  ...
  return (
    <button
      type="button"
      onClick={handlePrint}
      className="inline-flex items-center gap-2 rounded-full bg-ember px-5 py-2.5 text-sm font-semibold text-white shadow-sm transition hover:bg-ember/90 active:scale-95 print:hidden"
    >
      <svg
