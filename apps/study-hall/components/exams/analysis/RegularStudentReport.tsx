...
export function RegularStudentReport({ report, mode, section }: { report: Report; mode: "admin" | "student"; section?: ReportSection }) {
  ...
  return <div className="admin-flat-page" data-report-root>
    ...
    {show("trend") && <section id="personal-trend" className="admin-section"><h2 className="admin-section-title">날짜별 추이</h2>{hasTrend ? <ExamScoreChart results={trend} /> : <p className="admin-empty-state">직전 시험이 없어 비교할 수 없습니다. 다음 시험부터 표시됩니다.</p>}</section>}
